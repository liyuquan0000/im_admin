...
public class TransferAesEncrypt {
     ...
     * @throws Exception
     */
    public static String encryptContent(String content, String encryptType, String encryptKey, String charset) throws AesException {
        ...
        if (AES_ALG.equals(encryptType)) {
            ...
            throw new AesException("当前不支持该算法类型：encrypeType=" + encryptType);
        }
     ...
     * @throws Exception
     */
    public static String aesEncrypt(String content, String aesKey, String charset)throws AesException {
        ...
        try {
            ...
            throw new AesException("AES加密失败：Aescontent = " + content + "; charset = " + charset, e);
        }
     ...
     * @throws Exception
     */
    public static String aesDecrypt(String content, String key, String charset)throws AesException {
        try {
            Cipher cipher = Cipher.getInstance(AES_CBC_PCK_ALG);
            IvParameterSpec iv = new IvParameterSpec(initIv());
            ...
            throw new AesException("AES解密失败：Aescontent = " + content + "; charset = " + charset, e);
        }
    }
     ...
     * @throws Exception
     */
    public static String aesDecrypt(String content, String key, String charset,String ivStr) throws AesException {
        try {
            Cipher cipher = Cipher.getInstance(AES_CBC_PCK_ALG);
            IvParameterSpec iv = new IvParameterSpec(ivStr.getBytes());
